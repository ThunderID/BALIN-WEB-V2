			...
			<div class="col-sm-4 col-md-3">
				...
				<a href="{{ $data['shop_by_style'][1]['action_url'] }}">
					<div class="tile text-center">
						...
						<div class="jumbotron">
							<h2>{{ strtoupper($data['shop_by_style'][1]['caption']) }}</h2>
						</div>
					</div>
				</a>
				@endif
			...
			<div class="col-sm-8 col-md-9">
				...
				<a href="{{ $data['shop_by_style'][2]['action_url'] }}">
					<div class="tile text-center">
						...
						<div class="jumbotron">
							<h2>{{ strtoupper($data['shop_by_style'][2]['caption']) }}</h2>
						</div>
					</div>
				</a>
				@endif
				...
				@if(array_key_exists('3', $data['shop_by_style']) == true)
					<a href="{{ $data['shop_by_style'][3]['action_url'] }}">
						<div class="tile text-center">
							...
							<div class="jumbotron">
								<h2>{{ strtoupper($data['shop_by_style'][3]['caption']) }}</h2>
							</div>
						</div>
					</a>
				@endif
				...
				@if(array_key_exists('4', $data['shop_by_style']) == true)
					<a href="{{ $data['shop_by_style'][4]['action_url'] }}">
						<div class="tile text-center">
							...
							<div class="jumbotron">
								<h2>{{ strtoupper($data['shop_by_style'][4]['caption']) }}</h2>
							</div>
						</div>
					</a>
				@endif
				...
				@if(array_key_exists('5', $data['shop_by_style']) == true)
					<a href="{{ $data['shop_by_style'][5]['action_url'] }}">				
						<div class="tile text-center">
							...
							<div class="jumbotron">
								<h2>{{ strtoupper($data['shop_by_style'][5]['caption']) }}</h2>
							</div>
						</div>
					</a>
				@endif	
